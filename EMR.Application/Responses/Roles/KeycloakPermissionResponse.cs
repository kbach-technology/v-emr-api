...
public class KeycloakPermissionResponse
{
    ...
    [JsonProperty("logic")] public string Logic { get; set; }

    [JsonProperty("decisionStrategy")] public string DecisionStrategy { get; set; }
    ...
    [JsonProperty("policies")] public List<string> Policies { get; set; }
}