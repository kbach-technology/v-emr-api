...
public interface IKeycloakAuthorizationService
{
    ...
    Task<Result<string>> CreateRoleWithPermissionsAsync(string roleName, Dictionary<string, List<string>> modulePermissions, CancellationToken cancellationToken);
    ...
    Task<Result<bool>> UpdatePermissionsAsync(string roleId, Dictionary<string, List<string>> modulePermissions, CancellationToken cancellationToken);
    ...
    Task<Result<bool>> AssignRolesToUserAsync(string userId, AssignRoleUserRequest request, CancellationToken cancellationToken);
    Task<Result<bool>> UnAssignRolesToUserAsync(string userId, AssignRoleUserRequest request, CancellationToken cancellationToken);
